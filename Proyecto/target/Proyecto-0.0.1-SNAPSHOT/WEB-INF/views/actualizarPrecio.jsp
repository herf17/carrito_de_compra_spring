...
function enviar(){
	...
	console.log(e);
	location.href = "${pageContext.request.contextPath}/admin/actualizarprecio/"+este+"/"+e+"/";
}
</script>
</head>
<body>
...
<c:forEach var="tempprecio" items="${precios}">
<tr>
<td Style="cursor:cell;" onclick="colorChanger(this);">${tempprecio.id}</td>
<td>${tempprecio.modelo}</td>
<td contenteditable="true">${tempprecio.precio}</td>
</tr>
