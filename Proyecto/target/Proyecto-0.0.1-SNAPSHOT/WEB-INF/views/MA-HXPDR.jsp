  ...
  <body>
    <div class="cab">
      ...
      <h1>${m.modelo}</h1>
          ...
          <ul>
            <li>Rápido: latencias más bajas combinadas con velocidades de reloj más rápidas para ofrecer un rendimiento inmejorable DDR4</li>

            
            <li>Único: disipador de calor en color carbón con PCB en negro para dar un estilo sofisticado a cualquier sistema</li>
            ...
            <li>Fácil de instalar: funcionalidad plug-and-play</li>
             ...
             <li>Confiable: 100% probado en fábrica para velocidad</li>
