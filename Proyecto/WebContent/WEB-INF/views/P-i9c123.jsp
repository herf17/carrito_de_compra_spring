    ...
    <div class="cab">
      ...
      <h1>${proces.modelo}</h1>
          ...
          <button onclick="delet('${proces.idproc}','${proces.modelo}','${proces.precio}','${proces.img}')">Agregar al carrito</button>
            ...
            <ul>
            <li>Gráficos del procesador</li>
            <li>Intel UHD Graphics</li>
            <li>Frecuencia de base de gráficos 300 MHz </li>
            <li>Frecuencia dinámica máxima de gráficos 1.15 GHz</li>
            <li>Memoria máxima de video de gráficos 32 GB</li>
            <li>Salida de gráficos eDP/DP/HDMI/DVI</li>
            <li>Unidades de ejecución 24</li>
            <li>Compatibilidad con 4K Yes, at 60Hz</li>
            <li>Resolución máxima (HDMI 1.4) 4096x2304@24Hz</li>
            <li>Resolución máxima (DP) 4096x2304@60Hz</li>
            <li>Resolución máxima (eDP - panel plano integrado) 4096x2304@60Hz</li>
            <li>Compatibilidad con DirectX* 12</li>
            <li>Compatibilidad con OpenGL* 4.5</li>
            <li>Intel® Quick Sync Video Sí</li>
            <li>Tecnología Intel® de video nítido Sí</li>
            <li>Nº de pantallas admitidas ‡3</li>
            <li>ID de dispositivo 0x9B41</li>
            <li>Tecnología Intel® de video nítido HD Sí</li>
          </ul>
          ...
          <table>
            ...
            <tr>
              <th>Tamaño de memoria máximo (depende del tipo de memoria) </th>
              <td>64 GB</td>
            </tr>
            <tr>
            ...
            <tr>
              <th>Cantidad máxima de canales de memoria</th>
              <td>2</td>
            </tr>
            <tr>
              <th>Máximo de ancho de banda de memoria </th>
              <td>41.66 GB/s</td>
            </tr>
            <tr>
